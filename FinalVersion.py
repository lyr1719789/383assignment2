...
os.system("gcloud compute --project=%s firewall-rules create open-ports --direction=INGRESS --priority=1000 --network=default --action=ALLOW --rules=tcp:6000-7000 --source-ranges=0.0.0.0/0"%manual.project)
os.system("gcloud compute --project=%s firewall-rules create open-ports --direction=EGRESS --priority=1000 --network=default --action=ALLOW --rules=tcp:6000-7000 --destination-ranges=0.0.0.0/0"%manual.project)
os.system("gcloud compute --project=%s firewall-rules create open-ports --direction=EGRESS --priority=1000 --network=default --action=ALLOW --rules=tcp:20-21 --destination-ranges=0.0.0.0/0"%manual.project)
os.system("gcloud compute --project=%s firewall-rules create open-ports --direction=INGRESS --priority=1000 --network=default --action=ALLOW --rules=tcp:20-21 --destination-ranges=0.0.0.0/0"%manual.project)
